 ...
 * 언어 감지
 */
export function detectLanguage(output: string): string | undefined {
 ...
 * 프레임워크 감지
 */
export function detectFramework(output: string): string | undefined {
 ...
 * 에러 심각도 판단
 */
export function getErrorSeverity(message: string): 'low' | 'medium' | 'high' | 'critical' {
